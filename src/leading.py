...
_METRIC_CLASSIFICATION = [
    ...
    ("Originator (third-party) performance", "Leading/oversight",
     "A weak channel's charge-off rate flags future losses from its pipeline"),
    ("Problem-exposure layer (DELINQ/PSTDUE/LIQUID/PURCH)", "Leading",
     "Non-performing pipeline; IN LIQUIDATION / guaranty-purchased ~ certain future charge-off"),
    ...
    ("Predictiveness validation (early signal vs final loss)", "Leading/validation",
     "Confirms the leading signals actually rank cohorts by eventual loss"),
]
